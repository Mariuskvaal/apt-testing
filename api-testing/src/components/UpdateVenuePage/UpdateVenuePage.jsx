...
const UpdateVenuePage = () => {
  const { venueId } = useParams(); // Use route params to identify the venue
  ...
  useEffect(() => {
    // Fetch venue details and pre-fill the form
    const fetchVenueDetails = async () => {
      try {
        ...
        console.error("Error fetching venue details:", error.response?.data || error);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error("Error updating venue:", error.response?.data || error);
  ...
  return (
    <>
      <Navbar />
      <div className="update-venue-container">
        <h1>Update Venue</h1>
